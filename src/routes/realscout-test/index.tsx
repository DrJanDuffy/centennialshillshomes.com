    ...
    <>
      <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
          ...
          <div id="realscout-office-listings" class="border border-gray-300 p-4 rounded-lg">
        ...
        <div class="mb-8">
          ...
          <div id="realscout-advanced-search" class="border border-gray-300 p-4 rounded-lg">
            <script src="https://em.realscout.com/widgets/realscout-web-components.umd.js" type="module"></script>
